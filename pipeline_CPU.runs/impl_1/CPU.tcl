...
namespace eval ::optrace {
  variable script "D:/code/pipeline_CPU/pipeline_CPU/pipeline_CPU.runs/impl_1/CPU.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/code/pipeline_CPU/pipeline_CPU/pipeline_CPU.runs/synth_1/CPU.dcp
